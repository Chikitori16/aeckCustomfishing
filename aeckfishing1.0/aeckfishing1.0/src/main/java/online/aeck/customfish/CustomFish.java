...
public class CustomFish extends JavaPlugin {
    ...
    // ── NamespacedKey cho PersistentDataContainer ─────────────────────────────
    public static NamespacedKey FISH_PRICE_KEY;
    /** Can nang ca (Double, kg) — doc duoc boi cac plugin khac */
    public static NamespacedKey FISH_WEIGHT_KEY;
    /** Chieu dai ca (Double, cm) — doc duoc boi cac plugin khac */
    public static NamespacedKey FISH_LENGTH_KEY;
    ...
    private FishConfigManager fishConfigManager;
    ...
    public void onEnable() {
        ...
        FISH_WEIGHT_KEY = new NamespacedKey(this, "aeck_fish_weight");
        FISH_LENGTH_KEY = new NamespacedKey(this, "aeck_fish_length");
        ...
        fishConfigManager = new FishConfigManager(this);
        ...
        Bukkit.getPluginManager().registerEvents(
                new FishCatchListener(this, combatManager), this
        );
        ...
        TopFishGUI topFishGUI = new TopFishGUI(this);
        Bukkit.getPluginManager().registerEvents(topFishGUI, this);

        SkillTreeGUI skillTreeGUI = new SkillTreeGUI(skillManager);
        Bukkit.getPluginManager().registerEvents(skillTreeGUI, this);
        ...
        // ----------------------------------------------------------------
        // SEASON TIMER: tu dong doi mua moi 30 phut thuc
        // ----------------------------------------------------------------
        Bukkit.getScheduler().runTaskTimer(this, () -> {
    ...
    public FishConfigManager getFishConfigManager()      { return fishConfigManager; }
}
